...
class CreateVideoList():
    def __init__(self, window):
        ...
        #Display total duration of all videos
    ...
    def rate_video_clicked(self):
        ...
        if selected_index:
            ...
            if lib.get_rating(video_number):
                ...
                new_review = self.__txt_new_review.get("1.0", tk.END).strip()
    ...
    def remove_from_playlist(self):
        ...
        if selected_index:
            ...
            self.total_duration -= lib.get_duration(removed_item.split(' ')[0])
    ...
    def display_cover_photo(self, video_number):
        base_path = r"OOP\VideoPlayer COMP1752\covers"
        ...
        self.cover_photo_label.config(image=photo,width=150, height=200)
